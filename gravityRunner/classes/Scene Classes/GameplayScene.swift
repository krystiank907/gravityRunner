...
override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
    ...
    private func initializeGame() {
        ...
        Timer.scheduledTimer(timeInterval: TimeInterval(itemContoller.randomBetweenNumbers(firstNum: 2, secondNum: 4)), target: self, selector: #selector(GameplayScene.spawnItems), userInfo: nil, repeats: true);
    ...
    @objc func spawnItems() {
        self.scene?.addChild(itemContoller.spawnItems(camera: mainCamera!));
    }
